#### Compiling a list of the various custom roms and where to get them from, for more info on each one and current list of <branches> visit the provided URL's:  
...
5. Blue Lightning  **Currently only cm11 available**  
homepage =  None?  
...
21. Nameless ROM **Currently only 4.4 available**  
...
26. RootBox **regular homepage seems to be down**  
...
28. SuperNexus **Currently only kitkat available**  
homepage =  none?  
